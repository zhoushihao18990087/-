...
import com.example.group.fragment.BookfourFragment;
import com.example.group.fragment.BookthreeFragment;
...
public class GoodsPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        if (position == 0) { // 第一页展示书籍封面
            ...
            return new BookthreeFragment();}
        else if (position == 3) {
            return new BookfourFragment();
        }
        return new BookCoverFragment();
    }
