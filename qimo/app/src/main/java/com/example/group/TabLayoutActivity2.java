...
import com.example.group.adapter.GoodsPagerAdapter2;
...
public class TabLayoutActivity2 extends AppCompatActivity implements OnTabSelectedListener {
...
//        tab_title.addTab(tab_title.newTab().setText(mTitleArray.get(1)));
    ...
    private void initTabViewPager() {
        ...
        // 构建一个商品信息的翻页适配器
        GoodsPagerAdapter2 adapter = new GoodsPagerAdapter2(
