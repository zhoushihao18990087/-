...
import com.example.group.adapter.GoodsPagerAdapter1;
...
public class TabLayoutActivity1 extends AppCompatActivity implements OnTabSelectedListener {
...
//        tab_title.addTab(tab_title.newTab().setText(mTitleArray.get(1)));
    ...
    private void initTabViewPager() {
        ...
        // 构建一个商品信息的翻页适配器
        GoodsPagerAdapter1 adapter = new GoodsPagerAdapter1(
