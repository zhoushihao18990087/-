...
import com.example.group.adapter.GoodsPagerAdapter5;
...
public class TabLayoutActivity5 extends AppCompatActivity implements OnTabSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_layout5);
...
//        tab_title.addTab(tab_title.newTab().setText(mTitleArray.get(1)));
    ...
    private void initTabViewPager() {
        ...
        // 构建一个商品信息的翻页适配器
        GoodsPagerAdapter5 adapter = new GoodsPagerAdapter5(
