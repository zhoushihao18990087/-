...
import com.example.group.util.DateUtil2;
...
public class loginMainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    private static final String TAG = "loginMainActivity"; //Log提示信息
    ...
    private void loginSuccess() {
        ...
        if (bRemember) {
            ...
            info.update_time = DateUtil2.getNowDateTime("yyyy-MM-dd HH:mm:ss");
        ...
        builder.setPositiveButton("确定跳转到商城", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(loginMainActivity.this,SearchViewActivity.class);
