...
import com.example.group.adapter.GoodsPagerAdapter7;
...
public class TabLayoutActivity7 extends AppCompatActivity implements OnTabSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_layout7);
...
//        tab_title.addTab(tab_title.newTab().setText(mTitleArray.get(1)));
    ...
    private void initTabViewPager() {
        ...
        // 构建一个商品信息的翻页适配器
        GoodsPagerAdapter7 adapter = new GoodsPagerAdapter7(
