...
import com.example.group.adapter.GoodsPagerAdapter8;
...
public class TabLayoutActivity8 extends AppCompatActivity implements OnTabSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_layout8);
...
//        tab_title.addTab(tab_title.newTab().setText(mTitleArray.get(1)));
    ...
    private void initTabViewPager() {
        ...
        // 构建一个商品信息的翻页适配器
        GoodsPagerAdapter8 adapter = new GoodsPagerAdapter8(
