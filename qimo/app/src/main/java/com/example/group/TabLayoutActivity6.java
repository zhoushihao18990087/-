...
import com.example.group.adapter.GoodsPagerAdapter6;
...
public class TabLayoutActivity6 extends AppCompatActivity implements OnTabSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_layout6);
...
//        tab_title.addTab(tab_title.newTab().setText(mTitleArray.get(1)));
    ...
    private void initTabViewPager() {
        ...
        // 构建一个商品信息的翻页适配器
        GoodsPagerAdapter6 adapter = new GoodsPagerAdapter6(
